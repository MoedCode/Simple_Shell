...
int main( int argc, char **argv)
{
 ...
 status = getline(&command, &getLine, 
# 17 "main.c" 3 4
                                     stdin
# 17 "main.c"
                                          );
 ...
 comArgs = tokenize(command, " \n");

 printDblArr(comArgs,0);

 do { if (command) { free(command); command = 
# 28 "main.c" 3 4
((void *)0)
# 28 "main.c"
; } } while(0);
 { if (comArgs) { freeDoubleArray(comArgs); comArgs = 
# 29 "main.c" 3 4
((void *)0)
# 29 "main.c"
; } } while(0);
